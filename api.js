...
api.getUser = async function (request, reply) {
    ...
    return reply.view(path.join(__dirname, "/src/pages/user.hbs"), params);
};
...
api.browserHistoryPage = async function (request, reply) {
    ...
    return reply.view("/src/pages/browserHistory.hbs", params);
};
...
api.projectPage = async function getProjectPage(request, reply) {
    ...
    return reply.view("/src/pages/project.hbs", params);
};
